                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="billing-info-wrap mr-100">
                                        ...
                                        <br>
                                        <div class="row" style="display: none;" id="entreprise">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="billing-info mb-25">
                                                    <label>Entreprise<span class="required" title="required">*</span></label>
                                                    <select class="js-example-basic-single form-control" name="entreprise_id">
...
<script>
  $(document).ready(function() {
      $('#rencontrebtob').on( 'change', function (e) {
